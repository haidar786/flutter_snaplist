  ...
  void initState() {
    ...
    _snipController = AnimationController(
      ...
      ..addListener(() {
        ...
        final snipCurve = widget.snipCurve;
        if (snipCurve != null) {
          resultAnimation =
              CurvedAnimation(parent: _snipController!, curve: snipCurve);
        }
    ...
    final initialPosition = widget.snaplistController?.initialPosition;
    if (initialPosition != null) {
      bloc?.explicitPositionChangeSink.add(initialPosition);
    }
